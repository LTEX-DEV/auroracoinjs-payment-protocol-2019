...
var varintBufNum = digibyte.encoding.BufferWriter.varintBufNum;

// BIP 70 - payment protocol
function PaymentProtocol(currency) {
  this.messageType = null;
  this.message = null;
  this.currency = currency || 'DGB';
}
...
PaymentProtocol.LEGACY_PAYMENT.REQUEST_CONTENT_TYPE = 'application/digibyte-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.CONTENT_TYPE = 'application/digibyte-payment';
PaymentProtocol.LEGACY_PAYMENT.ACK_CONTENT_TYPE = 'application/digibyte-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'DGB';
  this.setObj(obj);
  return this;
};
